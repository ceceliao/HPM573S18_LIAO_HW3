...
print('Expected costs of C1 is', C1.get_expected_cost(), 'Expected utility of C1 is', C1.get_expected_utility())
print('Expected costs of C3 is', C3.get_expected_cost(), 'Expected utility of C3 is', C3.get_expected_utility())
